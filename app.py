...
if uploaded_file is None:
    st.info("Upload file .nc terlebih dahulu (contoh: data curah hujan bulanan).")
    st.stop()

try:
    ds_tmp = xr.open_dataset(uploaded_file)
...
# Hitung climatology
try:
    clim = load_and_climatology(uploaded_file, var_name)
except Exception as e:
